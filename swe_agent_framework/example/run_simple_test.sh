...
# =============================================================================
export MODEL_PATH=/home/wtc/models/qwen3-0.6b
export WORK_BASE=/home/wtc/swe_workspace
...
# ================= Experiment =================
agent_loop_config_path=$RECIPE_DIR/config/swe_agent_config.yaml
...
python3 -m verl.trainer.main_ppo \
    ...
    actor_rollout_ref.rollout.agent_framework.enable=true \
    actor_rollout_ref.rollout.agent_framework.gateway_count=1 \
    actor_rollout_ref.rollout.agent_framework.agent_framework_class=recipe.swe_agent.swe_agent_framework.SWEAgentFramework \
    actor_rollout_ref.rollout.agent_framework.config_path="$agent_loop_config_path" \
